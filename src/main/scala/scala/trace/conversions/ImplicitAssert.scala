...
final case class ImplicitAssert[MyType](val me: MyType) {
  ...
  final def assert(assertion: (MyType) => Boolean, message: String, numLines: Int = Int.MaxValue): MyType = {
    Printer.internalAssert(message, numLines, isAssertTrue = assertion(me), isFatal = true)
    me
  }
  ...
  final def assertStdOut(assertion: (MyType) => Boolean, message: String, numLines: Int = Int.MaxValue): MyType = {
    if (!assertion(me) && Debug.isFatalAssertOn) {
      Printer.internalAssert(message, numLines, usingStdOut = true, isAssertTrue = assertion(me), isFatal = true)
      System.exit(7)
    }
    me
  }
  ...
  final def assertEquals[OtherType](other: OtherType, message: String, numLines: Int = Int.MaxValue): MyType = {
    Printer.internalAssert(message, numLines, usingStdOut = false, isAssertTrue = me.equals(other), isFatal = true)
    me
  }
  ...
  final def assertEqualsStdOut[OtherType](other: OtherType, message: String, numLines: Int = Int.MaxValue): MyType = {
    Printer.internalAssert(message, numLines, usingStdOut = true, isAssertTrue = me.equals(other), isFatal = true)
    me
  }
  ...
  final def check(assertion: (MyType) => Boolean, message: String, numLines: Int = Int.MaxValue): MyType = {
    Printer.internalAssert(message, numLines, usingStdOut = false, isAssertTrue = assertion(me), isFatal = false)
    me
  }
  ...
  final def checkStdOut(assertion: (MyType) => Boolean, message: String, numLines: Int = Int.MaxValue): MyType = {
    Printer.internalAssert(message, numLines, usingStdOut = true, isAssertTrue = assertion(me), isFatal = false)
    me
  }
  ...
  final def checkEquals[OtherType](other: OtherType, message: String, numLines: Int = Int.MaxValue): MyType = {
    Printer.internalAssert(message, numLines, usingStdOut = false, isAssertTrue = me.equals(other), isFatal = false)
    me
  }
  ...
  final def checkEqualsStdOut[OtherType](other: OtherType, message: String, numLines: Int = Int.MaxValue): MyType = {
    Printer.internalAssert(message, numLines, usingStdOut = true, isAssertTrue = me.equals(other), isFatal = false)
    me
  }
}
